...
import (
	...
	"github.com/metatechchain/meta-base/abft/election"
...
// Unlike abft.Meta, this raw level of abstraction doesn't track cheaters detection
type Orderer struct {
	config Config
	crit   func(error)
	store  *Store
...
// Unlike Meta, Orderer doesn't updates DAG indexes for events, and doesn't detect cheaters
