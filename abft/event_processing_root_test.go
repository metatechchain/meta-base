...
func TestMetaClassicRoots(t *testing.T) {
...
func TestMetaRandomRoots(t *testing.T) {
	// generated by codegen4MetaRandomRoot()
	testSpecialNamedRoots(t, `
 A1.01    
 ║         ║        
 ╠════════ B1.01    
...
func testSpecialNamedRoots(t *testing.T, scheme string) {
	...
	// init abft
	lch, _, input := FakeMeta(nodes, nil)
...
/*
// codegen4MetaRandomRoot is for test data generation.
func codegen4MetaRandomRoot() {
	nodes, events := inter.GenEventsByNode(4, 20, 2, nil)

	p, _, input := FakeMeta(nodes)
	// process events
	config := inter.Events{}
